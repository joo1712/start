...
for (var i = 0; i < scripts.length; i++) {
    if (scripts[i].src.indexOf('qcell.js') > 0) {
        myScript = scripts[i];
        break;
    }
}
if(window['RightTechPath'] === undefined)
	window['RightTechPath'] = '/';

if(window['RightTechLicense'] === undefined)
	window['RightTechLicense'] = '';

if(window['useRightTechJQuery'] === undefined)
	window['useRightTechJQuery'] = true;
...
if (myScript !== null){
	...
	var prop = parseQuery(queryString);

	if (prop !== undefined){
		window['RightTechPath'] = prop.RightTechPath === undefined ? window['RightTechPath'] :  prop.RightTechPath;
		window['RightTechLicense'] = prop.RightTechLicense === undefined ? window['RightTechLicense'] :  prop.RightTechLicense;
		window['useRightTechJQuery'] = prop.useRightTechJQuery === undefined ? window['useRightTechJQuery'] :  prop.useRightTechJQuery;
	}
